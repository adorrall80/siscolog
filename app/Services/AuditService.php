...
final class AuditService
{
    ...
    private function eventFor(Request $request): ?array
    {
        ...
        $rules = [
            ...
            ['POST', '#^/patients/(\d+)/ai-analysis/(\d+)/anular$#', 'anular_analisis_ia', 'ai_analysis', 2],
            ['GET', '#^/patients/(\d+)/vinculos$#', 'ver_vinculos', 'patient', 1],
            ['GET', '#^/patients/(\d+)/vinculos/pdf$#', 'exportar_mapa_vinculos', 'patient', 1],
            ['POST', '#^/patients/(\d+)/family-people$#', 'agregar_persona_vinculo', 'patient', 1],
            ['POST', '#^/patients/(\d+)/family-people/(\d+)/restaurar$#', 'restaurar_persona_vinculo', 'associated_person', 2],
